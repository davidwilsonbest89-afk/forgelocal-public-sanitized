...
- [x] T10-F1 : cadrage documentaire non normatif du lot T10 (contrats, dépendances, critères d'acceptation) — autorisation explicite requise AVANT ce document. Cadrage produit : `docs/T10_PROXIES_FRAMING.md` (T10-FRAMING-20260816-001, sans nouveau statut/exigence/certificat). (contrats, dépendances, critères d'acceptation) — autorisation explicite requise AVANT ce document.
